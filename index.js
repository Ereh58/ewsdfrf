...
try {
await client.guilds.cache.get(finitto.guildId).members.cache.get(efjr).roles.add(finitto.rolId) } catch{console.log(`${te.data.username} adli kullanici sunucuda olmadigi için rol veremedim.`)}
          return
        }
